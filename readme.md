...
its like [windows93](http://www.windows93.net/) and [windows 98](https://98.js.org/) - [forked](https://github.com/joshuaword2alt/98) and [another one](https://archive.org/details/windows-98-se-isofile) and [how to install](https://www.sysnettechsolutions.com/en/install-oracle-vm-virtualbox-on-windows-10/) and [atlasOS](https://github.com/Atlas-OS/Atlas) - [forked](https://github.com/joshuaword2alt/Atlas) and [vmkeys](https://gist.github.com/williamgh2019/cc2ad94cc18cb930a0aab42ed8d39e6f) [all](https://github.com/joshuaword2alt/json-template-engine) [vhs](https://github.com/JargeZ/ntscqt) [tts](https://github.com/joshuaword2alt/sam) [tts2](https://www.tetyys.com/SAPI4/) [ok](https://cloaksplus.com/) [ok2](https://mantle.gg/) [ok3](https://optifine.net/) [ok4](https://store.steampowered.com/app/410340/Liftoff_FPV_Drone_Racing/) [ok5](https://www.tinywhoop.com/)
